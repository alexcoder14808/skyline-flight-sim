...
export class AircraftControls {
    constructor(inputSettings = {}) {
        ...
        this.events = { cameraCycle: false, pause: false, reset: false, debugToggle: false, mapToggle: false };
    ...
    update(dt) {
        ...
        this._latch('map', () => { this.events.mapToggle = true; });
