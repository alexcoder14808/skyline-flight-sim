...
class SkylineFlightApp {
    ...
    _initScene() {
        ...
        this.camera = new THREE.PerspectiveCamera(62, window.innerWidth / window.innerHeight, 0.5, 27000);
    ...
    _applySettingsToRenderer(values) {
        ...
        const distanceMap = { near: 8000, medium: 16000, far: 27000 };
        this.camera.far = distanceMap[values.renderDistance] || 27000;
        this.camera.updateProjectionMatrix();
