...
class SkylineFlightApp {
    ...
    // The map can be opened from the main menu OR mid-flight (via pause), so
    // it's handled as an overlay on top of whichever state it was opened
    // from, rather than going through the normal menu-only _switchScreen.
    _openMap(fromState) {
