...
const PRESETS = {
    day: { elevation: 55, azimuth: 150, turbidity: 2.6, rayleigh: 1.2, fogColor: 0xbfd6e8, fogDensity: 0.00003, ambient: 0.55, sunIntensity: 2.6 },
...
export class Environment {
    ...
    _applyPreset(p) {
        ...
        // sun (easy to do with the free-look camera, or just climbing with
        // a bit of pitch) could wash the entire screen to flat white. Kept
        // deliberately conservative here since this can't be tested in an
        // actual browser from this environment.
