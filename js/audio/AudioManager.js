...
export class AudioManager {
    ...
    _buildMusic() {
        const ctx = this.ctx;
        const notes = [220, 277.18, 329.63, 369.99]; // A minor-ish pad
        this._musicOscs = notes.map((freq, i) => {
            ...
            osc.start();
            // Slow independent LFO per note for a gentle evolving pad.
            ...
            lfo.start();
            g.gain.setTargetAtTime(0.05, ctx.currentTime + i * 4, 6);
            return { osc, g, lfo };
        });
    }
